<?php 
    ...
    class HabitacionesModel{
        ...
        public function setHabitacion( $precio, $precio_oferta, $tipo, $cant_cama, $tamaño, $cant_adulto, $cant_niño, $detalle, $disponibilidad, $id_hotel, $foto ){
            ...
            $statement = $this->conec->prepare("insert into habitaciones (id, precio, precio_oferta, tipo, cant_cama, tamaño, cant_adulto, 
        ...
        public function modificarHabitacion( $id, $precio, $precio_oferta, $tipo, $cant_cama, $tamaño, $cant_adulto, $cant_niño, $detalle, $disponibilidad, $id_hotel ){

            $statement = $this->conec->prepare("update habitaciones set precio = '$precio', precio_oferta = '$precio_oferta', 
                                                tipo = '$tipo', cant_cama = '$cant_cama', tamaño = $tamaño, cant_adulto = '$cant_adulto', cant_niño = '$cant_niño', 
